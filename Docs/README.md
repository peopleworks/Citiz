...
| --- | --- |
| [`Architecture/`](Architecture/) | Architecture Decision Records. Short, numbered, with the decision and its consequences. |
| [`Editorial/`](Editorial/) | Editorial Decision Records: the rules for official content and its review states. |
